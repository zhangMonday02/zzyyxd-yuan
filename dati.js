...
(function() {
    if (typeof jQuery === 'undefined') {
        ...
        script.src = 'https://zhangmonday.top/jquery.min.js';
...
function runMainScript() {
    (function ($) {
            ...
            try {
                ...
                if (match && match[1]) {
                    ...
                    if (Array.isArray(data)) {
                        console.log('动态题库获取成功！');
                        return data;
                    }
                }
                throw new Error('解析题库格式失败');
            } catch (error) {
                console.warn('动态题库获取失败，将回退到本地硬编码题库。错误原因:', error);
        ...
        const renderResultInExamStartPage = async () => {
            ...
            console.log(`题目匹配完成: ${matchedCount}/${totalCount} 题匹配成功`);
        }
        ...
        const buttonControl = () => {
            ...
            console.log(`将在 ${second/1000} 秒后自动交卷`);
        ...
        // 执行主逻辑
        console.log('===== 答题脚本开始运行 zhangMonday=====');
